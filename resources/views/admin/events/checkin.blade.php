        ...
        <tbody>
            @foreach ($usuarios_evento as $usuario)
                ...
                <tr>
                    ...
                    <td class="text-break"><a href="#" onclick="preencherCPF('{{$usuario->cpf}}'); checkinout('/admin/presenca/checkin', {{ request('id_evento') }}, this, false, 'in')" id="cpf-usuario">{{$usuario->cpf}}</a></td>
