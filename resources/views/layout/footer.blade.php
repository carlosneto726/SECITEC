...
<footer
    ...
    <!-- Section: Links -->
      <div class="row justify-content-center text-center border-bottom mt-3 pb-3">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-4 mb-4 mb-md-0">
          <a href="tel:+556136429450">
            ...
            <div class="d-none d-sm-block">
              <p class="fs-5 pt-3">(61)3642-9450</p>
            </div>
          </a>
        </div>
        <!--column endereço-->
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-4 mb-4 mb-md-0">
            ...
            <div class="d-none d-sm-block">
              <p class="fs-5 pt-3">secitec2023@gmail.com</p>
            </div>
          </a>
        </div>
      </div>
  ...
  <div class="text-center p-4" >
    <p class="fs-6">
      © 2023 Copyright:
      <a class="text-dark" href="https://www.ifg.edu.br/" target="_blank"
        >ifg.edu.br</a
        >
    </p>
  </div>
