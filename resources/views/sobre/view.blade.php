            ...
            <div class="col-lg-12 col-12 p-5 ">
                ...
                <div class="row" >
                    <div class="col align-self-center">
                        ...
                        <p class="mb-5">Ao chegar ao evento, você será solicitado a fazer o <span class="text-success fw-bolder">check-in</span> escaneando seu <span class="text-success fw-bolder">QR Code</span>. Da mesma forma, quando você sair do evento, será necessário fazer o <span class="text-success fw-bolder">check-out</span>, escaneando novamente o seu <span class="text-success fw-bolder">QR Code</span>. Isso nos ajudará a manter um registro preciso de quem está presente e quando deixam o local.</p>
